...
"""
OUT_FILE = "vptc10.dxf" # Имя файла в который будет сохранен профиль
RESOLUTION = 600       # Количество точек построения профиля жесткого колеса
i = 10                  # Нужное вам передаточное число
dsh = 8                # Диаметр шариков от подшипника
Rout = 32.45              # Внешний радиус впадин жесткого колеса
D = 75                 # Внешний диаметр редуктора (опционально)
