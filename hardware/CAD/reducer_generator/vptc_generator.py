...
i = 7                  # Нужное вам передаточное число
dsh = 4                # Диаметр шариков от подшипника
Rout = 13              # Внешний радиус впадин жесткого колеса
D = 28                 # Внешний диаметр редуктора (опционально)
